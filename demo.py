...
def create_markdown_reports(context):
    ...
    # ==========================================
    json_report = "reports/automated_system_report.json"
    
    # We export the pre-sanitized 'report' dictionary generated by the ReportAgent
    # because it is specifically built to be JSON-serializable for the LLM.
    report_data = context.get("report", {})
