...
def update_incremental_speed(current_speed,current_elapsed_seconds,new_pieces,new_elapsed_seconds):

    if new_elapsed_seconds <= 0:
        return (current_speed,current_elapsed_seconds)

    interval_speed = (new_pieces / new_elapsed_seconds * 3600)

    total_elapsed_seconds = (current_elapsed_seconds + new_elapsed_seconds)

    updated_speed = ((current_speed * current_elapsed_seconds)+(interval_speed * new_elapsed_seconds)) / total_elapsed_seconds

    return (updated_speed,total_elapsed_seconds)